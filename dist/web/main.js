...
/* harmony import */ var _operaciones_operaciones_nombreruta_operaciones_nombreruta_component__WEBPACK_IMPORTED_MODULE_35__ = __webpack_require__(/*! ./operaciones/operaciones-nombreruta/operaciones-nombreruta.component */ "./src/app/operaciones/operaciones-nombreruta/operaciones-nombreruta.component.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var routes = [
    ...
    { path: 'ruta/:nombre', component: _operaciones_operaciones_nombreruta_operaciones_nombreruta_component__WEBPACK_IMPORTED_MODULE_35__["OperacionesNombrerutaComponent"], canActivate: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_22__["AuthGuard"]] },
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            declarations: [
                ...
                _operaciones_operaciones_creartransporte_operaciones_creartransporte_component__WEBPACK_IMPORTED_MODULE_30__["OperacionesCreartransporteComponent"],
                _usuario_usuario_navbar_usuario_navbar_component__WEBPACK_IMPORTED_MODULE_33__["UsuarioNavbarComponent"],
                _operaciones_operaciones_nombreruta_operaciones_nombreruta_component__WEBPACK_IMPORTED_MODULE_35__["OperacionesNombrerutaComponent"],
            ],
            imports: [
...
/***/ "./src/app/operaciones/operaciones-nombreruta/operaciones-nombreruta.component.css":
/*!*****************************************************************************************!*\
  !*** ./src/app/operaciones/operaciones-nombreruta/operaciones-nombreruta.component.css ***!
  \*****************************************************************************************/
/*! no static exports found */
...
/***/ "./src/app/operaciones/operaciones-nombreruta/operaciones-nombreruta.component.html":
/*!******************************************************************************************!*\
  !*** ./src/app/operaciones/operaciones-nombreruta/operaciones-nombreruta.component.html ***!
  \******************************************************************************************/
/*! no static exports found */
...
module.exports = "<body>\r\n    <!-- Barra de Navegación Superior -->\r\n    <app-operaciones-navbar></app-operaciones-navbar>\r\n    <div class=\"row\">\r\n      <!-- Barra de Navegación Lateral -->\r\n      <app-operaciones-sidenav></app-operaciones-sidenav>\r\n  \r\n      <!-- Lista de oficinas -->\r\n      <div class=\"col s9 offset-s6\">\r\n          </div>  \r\n         \r\n          \r\n      <div class=\"col s9 offset-s3\" *ngIf=\"arr.length>0;else noData\">\r\n          <h4 col s3>Administracion de Rutas</h4>\r\n            <div class=\"col s12 l4\" *ngFor=\"let envio of arr ; let i = index\">\r\n                \r\n              <div class=\"card-stacked\">\r\n                 \r\n                <div class=\"card grey darken-4 white-text\">\r\n                    \r\n                  <div class=\"card-content\">\r\n                      \r\n                      <p>nombre de la subruta: {{envio.nombreRuta}}</p>\r\n                      <p>timepo: {{envio.tiempoRecorrido}}</p>\r\n                      \r\n                  </div>\r\n                 </div>\r\n               </div>\r\n             </div>\r\n          \r\n  </div>\r\n  </div>\r\n  \r\n  \r\n  </body>\r\n  "

/***/ }),

/***/ "./src/app/operaciones/operaciones-nombreruta/operaciones-nombreruta.component.ts":
/*!****************************************************************************************!*\
  !*** ./src/app/operaciones/operaciones-nombreruta/operaciones-nombreruta.component.ts ***!
  \****************************************************************************************/
/*! exports provided: OperacionesNombrerutaComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "OperacionesNombrerutaComponent", function() { return OperacionesNombrerutaComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _services_auth_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../services/auth.service */ "./src/app/services/auth.service.ts");
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/forms */ "./node_modules/@angular/forms/fesm5/forms.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm5/router.js");
...
var OperacionesNombrerutaComponent = /** @class */ (function () {
    function OperacionesNombrerutaComponent(authService, _data, route, fb) {
        this.authService = authService;
        this._data = _data;
        this.route = route;
        this.fb = fb;
    ...
    OperacionesNombrerutaComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.nombre = this.route.snapshot.params['nombre'];
        console.log(this.nombre);
        // Obtenemos las guias registradas en la base de datos.
        this.firebaseSubscription = this._data.getFiltroruta(this.nombre).subscribe(function (subruta) {
            _this.arr = subruta;
            console.log(_this.arr);
            _this.arr.forEach(function (element, i) {
                _this.tiempo[i] += element.tiempoRecorrido;
            });
            _this.tiempos = Array.from(_this.tiempo);
            console.log(_this.tiempos);
        });
    };
    // Finalizamos la suscripción con el servicio al cerrar el componente.
    OperacionesNombrerutaComponent.prototype.ngOnDestroy = function () {
        this.firebaseSubscription.unsubscribe();
    };
    OperacionesNombrerutaComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'app-operaciones-nombreruta',
            template: __webpack_require__(/*! ./operaciones-nombreruta.component.html */ "./src/app/operaciones/operaciones-nombreruta/operaciones-nombreruta.component.html"),
            styles: [__webpack_require__(/*! ./operaciones-nombreruta.component.css */ "./src/app/operaciones/operaciones-nombreruta/operaciones-nombreruta.component.css")]
        }),
        __metadata("design:paramtypes", [_services_auth_service__WEBPACK_IMPORTED_MODULE_1__["AuthService"], _services_firestore_subrutas_service__WEBPACK_IMPORTED_MODULE_4__["FirestoreSubrutasService"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["ActivatedRoute"], _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"]])
    ], OperacionesNombrerutaComponent);
    return OperacionesNombrerutaComponent;
}());
...
var FirestoreSubrutasService = /** @class */ (function () {
    ...
    FirestoreSubrutasService.prototype.getFiltroruta = function (nombre) {
        this.subRutacollection = this._afs.collection('/subrutas', function (ref) {
            return ref
