...
var OperacionesAsigtransporteComponent = /** @class */ (function () {
    ...
    OperacionesAsigtransporteComponent.prototype.ngOnInit = function () {
        ...
        this.firebaseEnvioSubscription = this._miDestino.getEnvios().subscribe(function (envios) {
            _this.arr = envios;
        });
        this.transporte = this.route.snapshot.params['transporte'];
        console.log(this.transporte);
...
module.exports = "<body>\r\n  <!-- Barra de Navegación Superior -->\r\n  <app-operaciones-navbar></app-operaciones-navbar>\r\n  <div class=\"row\">\r\n    <!-- Barra de Navegación Lateral -->\r\n    <app-operaciones-sidenav></app-operaciones-sidenav>\r\n\r\n    <!-- Lista de oficinas -->\r\n    <div class=\"col s9 offset-s3\" *ngIf=\"arr.length>0;else noData\">\r\n          <div class=\"col s12 m4\" *ngFor=\"let envio of arr\">\r\n            <div class=\"card-stacked\">\r\n              <div class=\"card grey darken-4 white-text\">\r\n                <div class=\"card-content\">\r\n                  <p>- # de Tracking: {{envio.id}}</p>\r\n                  <p>Destinatario: {{envio.destinatario.nombre}}  {{envio.destinatario.apellido}}</p>\r\n                  <p>Destino: {{envio.detalles.destino}} </p>\r\n                  <p>Tipo de Carga: {{envio.tipo}} </p>\r\n                  <p>Metodo de Envio: {{envio.detalles.tipoEnvio}} </p>\r\n                </div>\r\n              <div class=\"card-action\">\r\n                <a class=\"pointer-delete modal-trigger\" (click)=\"onUpdate(envio)\"  href=\"#modalNE\" materialize=\"modal\">Asignar Transporte</a>\r\n              </div>\r\n      </div>\r\n          </div>\r\n  </div>\r\n</div>\r\n</div>\r\n\r\n<!-- Modal que contiene el formulario de asignacio del transporte. -->\r\n<div id=\"modalNE\" class=\"modal modal-fixed-footer\">\r\n    <div class=\"modal-content row\">\r\n      <h4>Asignar Transporte</h4>\r\n      <form [formGroup]=\"newEstadoForm\">\r\n\r\n\r\n        <div class=\"input-field col s3\">\r\n            <select formControlName=\"idTransporte\" class=\"browser-default form-control validate\" required>\r\n              <option disabled>ID Transporte</option>\r\n              <option *ngFor=\"let transporte of arrTransporte\" [value]=\"transporte.idPlaca\">{{transporte.idPlaca}}</option>\r\n          </select>\r\n          </div>\r\n\r\n      </form>\r\n    </div>\r\n\r\n    <div class=\"modal-footer\">\r\n      <button (click)='updateSubmit()'  class=\"modal-close btn-flat green-text\">Asignar</button>\r\n      <a class=\"modal-close btn-flat red-text\" (click)='cleanForm()'>Cancelar</a>\r\n    </div>\r\n</div>  <!-- Fin de modal de crear envío (paquete) -->\r\n</body>\r\n"
...
var OperacionesTransporteComponent = /** @class */ (function () {
    function OperacionesTransporteComponent(authService, _data, route, fb, _misTransporte) {
        this.authService = authService;
        this._data = _data;
        this.route = route;
        this.fb = fb;
    ...
    OperacionesTransporteComponent.prototype.ngOnChanges = function () {
        this.cleanForm();
    };
    OperacionesTransporteComponent.prototype.createForm = function () {
        this.newEstadoForm = this.fb.group({
            estado: 'Cargado',
            idTransporte: ['idTransporte', _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required],
            newEstado: this.fb.group({
                estado: 'Cargado',
                fecha: '',
            })
    ...
    /* Función que limpia el modelo del formulario para la actualización
     de los estados de los envíos. */
    OperacionesTransporteComponent.prototype.cleanForm = function () {
        this.newEstadoForm.reset({
    ...
    OperacionesTransporteComponent.prototype.onUpdate = function (envio) {
        this.iE = envio.id;
    };
    OperacionesTransporteComponent.prototype.updateSubmit = function () {
        var newEH = {};
        this.newEstadoForm.patchValue({
            newEstado: {
                estado: this.newEstadoForm.get('estado').value,
    ...
    OperacionesTransporteComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_services_auth_service__WEBPACK_IMPORTED_MODULE_1__["AuthService"], _services_firestore_envios_service__WEBPACK_IMPORTED_MODULE_4__["FirestoreEnviosService"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["ActivatedRoute"], _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"],
            _services_firestore_transportes_envio_service__WEBPACK_IMPORTED_MODULE_5__["FirestoreTransportesEnvioService"]])
